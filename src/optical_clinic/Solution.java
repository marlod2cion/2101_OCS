...
public class Solution extends javax.swing.JFrame {
    ...
    private void SNActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SNActionPerformed
        // TODO add your handling code here:
        String insurance = SN.getSelectedItem().toString();
        if (insurance.equals("Others")) {
            String otherInsurance = JOptionPane.showInputDialog(null, "Please specify the brand name:");
            ...
            SN.insertItemAt(insurance, selectedIndex); 
            SN.removeItemAt(selectedIndex + 1); 
            SN.setSelectedItem(insurance);
        } 
