...
public class Frame extends javax.swing.JFrame {
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        ...
                        .addComponent(FP, javax.swing.GroupLayout.PREFERRED_SIZE, 185, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void FSActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_FSActionPerformed
        // TODO add your handling code here:
        String insurance = FS.getSelectedItem().toString();
        if (insurance.equals("Others")) {
            String otherInsurance = JOptionPane.showInputDialog(null, "Please specify the shape:");
            if (otherInsurance == null || otherInsurance.trim().isEmpty()) {
                JOptionPane.showMessageDialog(null, "You must specify the shape!");
                return; 
            }
            ...
            FS.insertItemAt(insurance, selectedIndex); 
            FS.removeItemAt(selectedIndex + 1); 
            FS.setSelectedItem(insurance);
        } 
    ...
    private void FMActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_FMActionPerformed
        // TODO add your handling code here:
                String insurance = FS.getSelectedItem().toString();
        if (insurance.equals("Others")) {
            String otherInsurance = JOptionPane.showInputDialog(null, "Please specify the ma:");
            if (otherInsurance == null || otherInsurance.trim().isEmpty()) {
